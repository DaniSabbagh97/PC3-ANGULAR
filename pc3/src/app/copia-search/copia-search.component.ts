...
@Component({
  selector: 'app-copia-search',
  templateUrl: './copia-search.component.html',
  styleUrls: ['./copia-search.component.scss']
})
export class CopiaSearchComponent implements OnInit {
