...
modelo = cargarModelo('F:\proyectoComputacion3\PC3-ANGULAR\pc3-laravel/app\Http\Python\modelo.pkl')
matriz = cargarMatriz('F:\proyectoComputacion3\PC3-ANGULAR\pc3-laravel/app\Http\Python\matriz.pkl')
